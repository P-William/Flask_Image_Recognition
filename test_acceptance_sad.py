"""
Acceptance tests for the Flask application (sad path scenarios).
Tests ensure the application handles invalid or missing inputs correctly.
"""
...
def test_acceptance_missing_file(testing_client):
    """
    ...
    response = testing_client.post("/prediction", data={}, content_type="multipart/form-data")
